...
export default function ProductCard({ product, owned = false }) {
  ...
  return (
    <article className="flex h-full flex-col overflow-hidden rounded-2xl border border-primary-100/80 bg-white shadow-[0_10px_30px_rgba(50,103,172,0.05)] transition hover:-translate-y-0.5 hover:shadow-[0_14px_34px_rgba(50,103,172,0.1)]">
      <div className="relative aspect-square w-full overflow-hidden bg-[#edf5ff]">
        ...
        <span className="absolute bottom-3 left-4 inline-flex items-center gap-1.5 rounded-full bg-white/95 px-3 py-1 text-xs font-semibold capitalize text-[#4f6d9e] shadow-sm">
          <span className={`h-2 w-2 rounded-full ${owned ? "bg-emerald-400" : "bg-primary-400"}`} aria-hidden="true" />
          {status}
        </span>
      </div>
      ...
      <div className="flex flex-1 flex-col p-5 sm:p-6">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2 text-xs font-medium text-[#7890b5]">
          {product.productType && (
            <span className="rounded-full bg-primary-50 px-2.5 py-1 capitalize text-primary-600">
              {product.productType}
            </span>
          )}
          <span>
        ...
        <div className="mt-auto pt-5">
          {owned ? (
            <Link
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-primary-50 px-4 py-2.5 text-sm font-semibold text-primary-600 transition hover:bg-primary-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
            >
              {action}
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-primary-200 px-4 py-2.5 text-sm font-semibold text-primary-600 transition hover:bg-primary-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
            >
              {action}
              <ArrowRight size={16} aria-hidden="true" />
            </a>
            ...
            <button
              type="button"
              disabled
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-primary-200 px-4 py-2.5 text-sm font-semibold text-primary-600 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"
            >
              {action}
              <ArrowRight size={16} aria-hidden="true" />
            </button>
